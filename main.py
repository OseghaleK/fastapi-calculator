...
# Setup logging.
# The file handler is what I added here. Errors were already going to
# the console, but nothing survived past the session and successful
# operations were not being recorded at all.
LOG_DIR = Path("logs")
